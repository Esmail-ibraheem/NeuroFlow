...
class AutoTrainParams(BaseModel):
    ...
    project_name: str = Field(default="project-name", title="Project name")
    revision: Optional[str] = Field(default=None, title="Model revision")
    private: bool = Field(default=False, title="Private repository")
    num_gpus: int = Field(default=1, title="Number of GPUs")
